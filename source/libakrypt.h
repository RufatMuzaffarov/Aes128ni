...
/*! \brief Тестирование корректной работы алгоритма блочного шифрования Aes-ni. */
 dll_export void ak_aes128ni_tests(void);
...
/*! \brief Инициализация секретного ключа алгоритма блочного шифрования Aes-ni. */
 dll_export int ak_bckey_create_aes( ak_bckey bkey );
